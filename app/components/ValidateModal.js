...
export default function ValidateModal({ placeId, open, onClose, filteredList, updateDecisionInList }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center" onClick={onClose}>
      <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg max-w-7xl w-full max-h-[95vh] overflow-y-auto p-6 relative" onClick={e => e.stopPropagation()}>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col lg:flex-row gap-4 mb-1">
